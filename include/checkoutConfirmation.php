...
<?php
if ($subTotal < 5000 and $subTotal != 35) {
	setcookie("state","");
	print("<tr class=\"content\"><td colspan=\"3\"><font color=\"red\">Invalid total amount sent.  Rejecting transaction.</font></td></tr>");
}
?>
    </table>
    <p>&nbsp;</p>
...
<?php
if ($subTotal != 35) {
	print('<input name="btnConfirm" type="submit" id="btnConfirm" value="Confirm Order &gt;&gt;" class="box">');
} 
?>
</form>
<p>&nbsp;</p>
